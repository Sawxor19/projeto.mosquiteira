...
# Atualização do projeto: (27/09/2025)
...
- Painel de controle adicionado com novas funções
- Banco de dados de clientes, sendo possível adicionar, editar e excluir clientes do banco de dados
- Botão para abrir uma nova venda, portanto ainda obsoleto

## Observações

O sistema ainda está bem cru, ando bem sem tempo para ficar mexendo no código, mas atualizando sempre que possível.
